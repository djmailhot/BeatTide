...
describe Album do
  ...
  it "should not allow names of greater than 200 characters" do
    album = Album.new(:title => "kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
    album.should_not be_valid
  end

  # Tries to create two albums with the same name
  it "should not allow duplicate album names" do
    album = Album.create(:title => "Example Album Name")
    secondary_album = Album.new(:title => "Example Album Name")
    album.should_not be_valid
  end

  # Should not allow an album to be created with a nil name
  it "should not allow nil name" do
    album_nil_name = Album.new(:title => nil)
